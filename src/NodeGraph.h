...
class NodeGraph {
  public:
    ...
    //Simboliza el menor peso
    int leastWeight;
    //Este es el arco para el nodo con menor peso que se conecta a estos
    int leastNode;
    // initializer
    NodeGraph();
    // Sera verdadero su el elemento esta en adyacente, de otra manera ser�a falso
    bool isAdj(int elm);
